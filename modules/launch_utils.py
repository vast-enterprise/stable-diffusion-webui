...
def prepare_environment():
    ...
    gfpgan_package = os.environ.get('GFPGAN_PACKAGE', "/mnt/pfs/users/huangzehuan/vastcode/stable-diffusion-webui/tmp/packages/GFPGAN-8d2447a2d918f8eba5a4a01463fd48e45126a379.zip")
    clip_package = os.environ.get('CLIP_PACKAGE', "/mnt/pfs/users/huangzehuan/vastcode/stable-diffusion-webui/tmp/packages/CLIP-d50d76daa670286dd6cacf3bcd80b5e4823fc8e1.zip")
    openclip_package = os.environ.get('OPENCLIP_PACKAGE', "/mnt/pfs/users/huangzehuan/vastcode/stable-diffusion-webui/tmp/packages/open_clip-bb6e834e9c70d9c27d0dc3ecedeebeaeb1ffad6b.zip")
